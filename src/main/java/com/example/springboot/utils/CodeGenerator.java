...
public class CodeGenerator {
    ...
    // 数据库名称
    private static final String DATASOURCE = "yjxt";
    
    // 你自己的项目路径，一定要改成你自己的！！结尾必须是:  \\springboot\\
    private static final String basePath = "D:\\daima\\java\\springboot\\";

    // 数据库需要生成代码的表名
    private static final String tableName = "grade";
    // 生成页面的菜单名称
    private static final String modelName = "成绩管理";
    ...
    private static final String url = "jdbc:mysql://127.0.0.1:3333/" + DATASOURCE;
