  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: 'msg',
        name: 'msg',
        component: () => import('../views/front/Msg.vue')
      },
      {
        path: 'paper',
        name: 'paper',
      ...
      },
      {
        path: 'record',
        name: 'record',
        component: () => import('../views/front/Record.vue')
      },
      {
        path: 'wrong',
        name: 'wrong',
        component: () => import('../views/front/Wrong.vue')
      },
    ]
  }
]
...
export const setRoutes = () => {
  ...
  if (storeMenus) {
    ...
    const manageRoute = { path: '/', name: 'Manage', component: () => import('../views/Manage.vue'), redirect: "/home", children: [
        ...
        { path: 'getPaper', name: 'getPaper', component: () => import('../views/GetPaper.vue')},
